...
export interface VisualSettings {
  ...
  shot_type?: 'Close-up' | 'Medium shot' | 'Full shot' | 'Wide shot' | 'Over-the-shoulder' | 'Point-of-view';
  visual_effects?: 'None' | 'Glitch' | 'VHS' | 'Film Grain' | 'Motion Blur' | 'Lens Flare' | 'Color Grading (Warm)' | 'Color Grading (Cool)';
}
